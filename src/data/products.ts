...
const productsData: ProductBase[] = [
  ...
  },
  {
    ...
    image: [
      {
        src: "/assets/margarita-tallo/margarita-tallo-01.jpeg",
        color: "blanco",
      },
      {
        src: "/assets/margarita-tallo/margarita-tallo-02.jpeg",
        color: "amarillo",
      },
    ],
    category: "margarita",
  ...
  },
  {
    ...
    description: ["Diámetro cada flor: 5 cm", "Largo total: 25 cm"],
    conditions: `Entrega estimada: ${getDeliveryDate(3)} (incluye 3 días de producción)`,
    image: [
      ...
      {src: "/assets/difusora-s/difusoras-s-6.jpeg", color: "gris"},
    ],
    category: "difusoras",
    status: "available",
    offer: false,
